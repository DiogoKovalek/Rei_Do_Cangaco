...
public class Game extends Canvas implements Runnable, KeyListener, MouseListener, MouseMotionListener {
    ...
    public static List<Entity> enemys;
    ...
    public Game() {
        ...
        spritesheet = new SpriteSheet("/res/ReiDoCangaco.png");
    ...
    public void initFrame() {
        frame = new JFrame("REI DO CANGACO");
        frame.add(this);
    ...
    public void tick() {
        ...
        if (GameState == GameStatePossible[0]) { // Home Screen

            home.tick();

        } else if (GameState == GameStatePossible[1]) { // Game
    ...
    public void render() {
        ...
        if (GameState == GameStatePossible[0]) { // Home Screen
            ...
            //Algoritimo para reorganizar a lista
            ...
            ui.render(g);
            windowsPowerUp.render(g);

            // Draw


        } else if (GameState == GameStatePossible[2]) { // Game Over
            gameOver.render(g);
...
//        ui.render(g);
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_RIGHT) {
            player.rightAin = false;
        } else if (e.getKeyCode() == KeyEvent.VK_LEFT) {
            player.leftAin = false;
        }
